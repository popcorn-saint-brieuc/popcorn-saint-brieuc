...
_Popcorn_ est une plateforme open source et (vraiment) sans frais ni commission qui aide les développeur-e-s freelance de Saint Brieuc à trouver des projets : [Voir le site](https://popcorn-saint-brieuc.github.io/)

Les objectifs de _Popcorn_ pour les développeurs freelances :

- 📈 Etre un canal pour trouver des affaires à Saint Brieuc sans commission ni intermédiaire
...
Pour soumettre une suggestion, signaler un bug, demander de l'aide, tu peux aussi tout simplement [ouvrir une issue sur ce repo](https://github.com/popcorn-saint-brieuc/issues/new)
...
- _Popcorn_ est réservé aux **développeur·e·s de Saint Brieuc**.
